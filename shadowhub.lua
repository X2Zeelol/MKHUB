...
OPENCLOSE.MouseButton1Click:Connect(function()
    game.CoreGui:FindFirstChild("MKUI").Enabled = not game.CoreGui:FindFirstChild("MKUI").Enabled
end)
do
    if game:GetService("CoreGui"):FindFirstChild("MKUI") then
        game:GetService("CoreGui").MKUI:Destroy()
    end
end
...
function Dino:CreateWindow(dinotitle)
    local MKUI = Instance.new("ScreenGui")
    local Window = Instance.new("Frame")
    local MKHUBText1 = Instance.new("TextLabel")
    local MKHUBText2 = Instance.new("TextLabel")
    ...
    MKUI.Name = "MKUI"
    MKUI.Parent = game.CoreGui
    MKUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    MKHUBText1.Name = "MKHUBText1"
    MKHUBText1.Parent = Window
    MKHUBText1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    MKHUBText1.BackgroundTransparency = 1.000
    MKHUBText1.BorderSizePixel = 0
    MKHUBText1.Position = UDim2.new(0, 5, 0, 0)
    MKHUBText1.Size = UDim2.new(0, 35, 0, 20)
    MKHUBText1.Font = Enum.Font.GothamSemibold
    MKHUBText1.Text = "MK999TH|HUB"
    MKHUBText1.TextColor3 = Color3.fromRGB(180, 180, 180)
    MKHUBText1.TextSize = 13.000
    
    MKHUBText2.Name = "MKHUBText2"
    MKHUBText2.Parent = Window
    MKHUBText2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    MKHUBText2.BackgroundTransparency = 1.000
    MKHUBText2.BorderSizePixel = 0
    MKHUBText2.Position = UDim2.new(0, 40, 0, 0)
    MKHUBText2.Size = UDim2.new(0, 35, 0, 20)
    MKHUBText2.Font = Enum.Font.GothamSemibold
    MKHUBText2.Text = "Hub |"
    MKHUBText2.TextColor3 = Color3.fromRGB(55, 122, 204)
    MKHUBText2.TextSize = 13.000
...
local DinoWindow = Dino:CreateWindow("Blox Fruit [ Made By วุฒิชัย กลหลัด ] ")
local DinoPage = DinoWindow:NewPage("ออโต้ฟาร์มเวล")
local Home = DinoPage:NewSection("ออโต้ฟาร์ม ฟังชั่น")

Home:CreateLabel("หากเจอบัคติดต่อ FB วุฒิชัยกลหลัด")
